...
plot_permeability_graph_by_volume <- function(ecoflex_n, vacuumed_bool, include_repeat = 0){
  
  avg_and_std %>%
    filter(ecoflex == ecoflex_n,
           vacuumed == vacuumed_bool,
           repeated == include_repeat) %>% 
...
plot_permeability_faceted_by_volume <- function(ecoflex_n, vacuumed_bool, include_repeat = 0){
...
plot_permeability_graph_by_mass <- function(ecoflex_n, vacuumed_bool, include_repeat = 0){
  avg_and_std %>%
    filter(ecoflex == ecoflex_n,
           vacuumed == vacuumed_bool,
           repeated == include_repeat) %>% 
...
plot_permeability_faceted_by_mass <- function(ecoflex_n, vacuumed_bool, include_repeat = 0){
...
* summarise the results
  ...
  * Graphs 
    * Graphs with volume ratio and inductance
    * Graphs with volume ratio and inductance
